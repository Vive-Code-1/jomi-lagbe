...
const translations = {
  bn: {
    ...
    // Add Listing
    addListing: 'বিজ্ঞাপন দিন',
    addListingTitle: 'জমির বিজ্ঞাপন দিন',
    addListingSubtitle: 'আপনার জমির তথ্য দিন এবং বিজ্ঞাপন প্রকাশ করুন',
    stepBasicInfo: 'মৌলিক তথ্য',
    stepLocation: 'লোকেশন',
    stepMedia: 'মিডিয়া ও শিরোনাম',
    stepPayment: 'পেমেন্ট',
    landType: 'জমির ধরন',
    residential: 'আবাসিক',
    ...
    freehold: 'ফ্রিহোল্ড',
    leasehold: 'লিজহোল্ড',
    totalSize: 'মোট পরিমাণ (শতক)',
    expectedPrice: 'প্রত্যাশিত দাম (৳)',
    division: 'বিভাগ',
    district: 'জেলা',
    detailAddress: 'বিস্তারিত ঠিকানা',
    detailAddressBn: 'বিস্তারিত ঠিকানা (বাংলা)',
    detailAddressEn: 'বিস্তারিত ঠিকানা (ইংরেজি)',
    imageUrls: 'ছবির লিঙ্ক',
    addImageUrl: 'ছবি যোগ করুন',
    removeImage: 'সরান',
    selectPackage: 'প্যাকেজ নির্বাচন করুন',
    listingSummary: 'বিজ্ঞাপনের সারসংক্ষেপ',
    submitListing: 'বিজ্ঞাপন প্রকাশ করুন',
    next: 'পরবর্তী',
    previous: 'পূর্ববর্তী',
    adPricing: 'বিজ্ঞাপনের মূল্য',
    perDay: 'প্রতি দিন',
    listingSuccess: 'আপনার বিজ্ঞাপন সফলভাবে প্রকাশিত হয়েছে!',
    loginRequired: 'বিজ্ঞাপন দিতে লগইন করুন',
    fillRequired: 'অনুগ্রহ করে সব তথ্য পূরণ করুন',
  ...
  en: {
    ...
    addListingTitle: 'Post Your Land Ad',
    addListingSubtitle: 'Fill in your land details and publish your advertisement',
    stepBasicInfo: 'Basic Info',
    stepLocation: 'Location',
    stepMedia: 'Media & Title',
    stepPayment: 'Payment',
    landType: 'Land Type',
    ...
    freehold: 'Freehold',
    leasehold: 'Leasehold',
    totalSize: 'Total Size (Decimal)',
    expectedPrice: 'Expected Price (৳)',
    division: 'Division',
    district: 'District',
    detailAddress: 'Detail Address',
    detailAddressBn: 'Detail Address (Bengali)',
    detailAddressEn: 'Detail Address (English)',
    ...
    perDay: 'per day',
    listingSuccess: 'Your listing has been published successfully!',
    loginRequired: 'Please login to post a listing',
